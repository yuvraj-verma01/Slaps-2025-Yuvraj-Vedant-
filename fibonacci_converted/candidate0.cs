// Dafny program candidate0.dfy compiled into C#
...
// Command Line Options: out_dir\candidate0.dfy
// candidate0.dfy
...
namespace fibonacci {
  ...
  public partial class __default {
    public static BigInteger nth__fibonacci(BigInteger n)
    {
      ...
      BigInteger _0_curr;
      _0_curr = BigInteger.Zero;
      BigInteger _1_prev1;
      _1_prev1 = BigInteger.One;
      BigInteger _2_prev2;
      _2_prev2 = BigInteger.Zero;
      BigInteger _3_i;
      _3_i = new BigInteger(2);
      while ((_3_i) < ((n) + (BigInteger.One))) {
        _0_curr = (_1_prev1) + (_2_prev2);
        _2_prev2 = _1_prev1;
        _1_prev1 = _0_curr;
