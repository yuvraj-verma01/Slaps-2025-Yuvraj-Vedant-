...
// Command Line Options: sum_squares_converted\candidate0.dfy
// candidate0.dfy
...
// end of class FuncExtensions
namespace sum__squares {

  public partial class __default {
    public static BigInteger sum__squares(BigInteger n)
    {
      BigInteger ret = BigInteger.Zero;
      BigInteger _0_i;
      _0_i = BigInteger.Zero;
      BigInteger _1_s;
      _1_s = BigInteger.Zero;
      while ((_0_i) < (n)) {
        _1_s = ((_1_s) + ((new BigInteger(2)) * (_0_i))) + (BigInteger.One);
